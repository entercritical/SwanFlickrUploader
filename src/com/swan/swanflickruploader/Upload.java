...
public class Upload {
    ...
    public void upload(File directory) throws IOException, SAXException, FlickrException {
...
//      }
        ...
        Upload upload = new Upload(new File(System.getProperty("user.home") + File.separatorChar + ".flickrAuth"));
        
        upload.upload(new File("/Users/janush/Documents/tmp/2005"));
    }
}
